  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const EditData = async (e) => {
      ...
      try {
        const { data } = await axios.put(
          `http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5002/api/categorys/updatecategorybyadmin/${id}`,
          {
            name,
            desc,
            photoActual,
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          <Container>
            <Form onSubmit={edit ? EditData  : AddD}>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="number"
                  min={0}
                  onChange={(e) => setPhotoActual(e.target.value)}
                />
              </Form.Group>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="number"
                  min={0}
                  onChange={(e) => setPhotoExpected(e.target.value)}
                />
              </Form.Group>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="number"
                  min={0}
                  onChange={(e) => setVideoExpected(e.target.value)}
                />
              </Form.Group>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="number"
                  min={0}
                  onChange={(e) => setDronActual(e.target.value)}
                />
              </Form.Group>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="number"
                  min={0}
                  onChange={(e) => setDronExpected(e.target.value)}
                />
              </Form.Group>

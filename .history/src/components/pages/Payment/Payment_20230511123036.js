...
const Payment = () => {
  ...
  const [ pdesc , setPName  ] = useState("")
  const [ pexceptedPrice , setPName  ] = useState("")
  const [ paccualPrice , setPName  ] = useState("")

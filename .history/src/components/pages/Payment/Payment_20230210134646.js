...
function MyVerticallyCenteredModal(props) {
  ...
  const AddData = async (e) => {
    e.preventDefault()
    try{
      const { data  } = await axios.post("http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5002/api/categorys/shoot/" , {name , desc , photoActual , photoExcepted , videoActual , videoExcepted})
    }catch(err){
      console.log(err)
    }
  }

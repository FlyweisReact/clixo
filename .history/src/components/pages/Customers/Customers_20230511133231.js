...
const Customers = () => {
            ...
            <Form onSubmit={EditCustomer}>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="tel"
                  pattern="[0-9]{10}"
                  placeholder={each?.data?.phoneNumber}
  ...
  return (
    <>
      ...
      <div>
        <div
          className="pb-4 w-full flex justify-between items-center bg-white"

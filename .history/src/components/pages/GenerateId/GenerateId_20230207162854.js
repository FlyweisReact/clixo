...
const GenerateId = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const [phoneNumber  , setPrice] = useState("")
    const [Gender ] = useState("")
    const [Camera ] = useState("")
    const [DateOfBirth ] = useState("")
    const [EquipmentSpecification ] = useState("")
    const [Website ] = useState("")
    const [SelectSkill ] = useState("")
    const [SelectExpertise ] = useState("")
    const [OtherExpertise ] = useState("")
    const [DrivingLicenseNumber ] = useState("")
    const [AadhaarCardNumber ] = useState("")
    const [ Howdoyoutransferdata] = useState("")

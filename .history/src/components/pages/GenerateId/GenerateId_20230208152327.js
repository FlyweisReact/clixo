          ...
          <Container>
            <Form onSubmit={AddHero}>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control type="file" onChange={(e) => setName(e.target.value)}  onChange={(e)=> setGadgetSide(e.target.files[0])}/>
              </Form.Group>
              <Form.Group className="mb-3">
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control type="text" onChange={(e) => setWebsite(e.target.value)}  onClick={() => postDetails()}/>
              </Form.Group>
              <Form.Group className="mb-3">

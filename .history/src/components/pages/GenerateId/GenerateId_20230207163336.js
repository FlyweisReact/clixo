...
const GenerateId = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const AddHero = async (e ) => {
      e.preventDefualt()
      const formD = { email , name , phoneNumber , Gender , Camera , DateOfBirth , EquipmentSpecification , Website , SelectExpertise , SelectSkill , OtherExpertise , DrivingLicenseNumber  , AadhaarCardNumber , Howdoyoutransferdata}
      try{
        const data = await axios.post("http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5002/api/heros/addherobyadmin" , )
      }catch(err){
        console.log(err)
      }
    }

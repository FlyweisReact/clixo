            ...
            <Form onSubmit={AddHero}>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Select aria-label="Default select example" onChange={(e) => setExpertise(e.target.value)}>
                  ...
                  <option value={''}>Maternity/Baby Photoshoot</option>
                  <option value={''}>Birthday Party (Adults)</option>
                  <option value={''}>Birthday Party (Kids)</option>
                  <option value={''}> Special Occasion / Function</option>
                  <option value={''}>Portriat/Fashion</option>
                  <option value={''}>Product/E-Com</option>
                  <option value={''}>Real Estate/Interior</option>
                  <option value={''}>Corporate/Industrial</option>
                  <option value={''}>Social Medial/Youtube</option>

...
const GenerateId = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const AddHero = async (e ) => {
      e.preventDefualt()
      const formD = { email , name , phoneNumber , Gender , Camera , DateOfBirth , EquipmentSpecification , Website , SelectExpertise , SelectSkill , OtherExpertise , DrivingLicenseNumber  , Adha}
      try{

  ...
  const fetchData = async () => {
    try {
      const { data } = await axios.get(
        "https://5mkj1ib4ve.execute-api.ap-south-1.amazonaws.com/dev/heroprivacypolicyRouter/get"
      );
    ...
    const postHandler = async (e) => {
      ...
      try {
        const data = await axios.post(
          "https://5mkj1ib4ve.execute-api.ap-south-1.amazonaws.com/dev/heroprivacypolicyRouter/create",
          { data: name }
        );
        console.log(data);
        toast.success("Added");
  ...
  const deleteHandler = async (id) => {
    try {
      const data = await axios.delete(
        `https://5mkj1ib4ve.execute-api.ap-south-1.amazonaws.com/dev/heroprivacypolicyRouter/${id}`
      );
      console.log(data);
      ...
      >
        <div className="pb-4 sticky top-0  w-full flex justify-between items-center bg-white">
          <span style={{ color: "black", fontSize: "20px", fontWeight: "400" }}>
            Privacy Policy (Total : {data?.length})
            <hr style={{ width: "70%" }} />
          </span>

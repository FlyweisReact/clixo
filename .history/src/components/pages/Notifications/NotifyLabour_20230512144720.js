            ...
            <tbody> 
              {data?.map((i, index) => (
                <tr key={index}>
                  ...
                  <td> 
                  {i.Status === "Ongoing" ? <p style={{color : 'blue' , fontWeight : 'bold'}} >Ongoing</p> : ""}
                  {i.Status === "Booked" ? <p style={{color : 'green' , fontWeight : 'bold'}} >Booked</p> : ""}
                  ...
                  {i.Status === "Scheduled" ? <p style={{color : '#3584e6' , fontWeight : 'bold'}} >Scheduled	</p> : ""}

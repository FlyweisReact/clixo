  ...
  function MyVerticallyCenteredModal(props) {
    const  [  Status , setStatus  ] = useState("")
      ...
      const chnageStatus = async () => {
        try {
          const { data } = await axios.put(`http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5002/paymentRouter/changeStatusbyidByAdmin/6402f15e4e4ff42383f9156e`)
        }catch(e) { 
          console.log(e)
        }
      }

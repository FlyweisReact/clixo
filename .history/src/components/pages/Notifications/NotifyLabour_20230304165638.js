  ...
  function MyVerticallyCenteredModal(props) {
    const  [  Status , setStatus  ] = useState("")
      ...
      const chnageStatus = async () => {
        try {
          const { data } = await axios.put(`http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5002/paymentRouter/changeStatusbyidByAdmin/${id}` , {
            Status
          })
          console.log(data)
          fetchData()
            ...
            <Form onSubmit={chnageStatus}>
              <Form.Group className="mb-3">
                ...
                <Form.Select aria-label="Default select example">
                  ...
                  <option value="Canceleed">Cancelled</option>

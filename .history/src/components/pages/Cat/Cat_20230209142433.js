...
const Cat = () => {
  ...
  const deleteheroBanner = async (id) => {
    try{
      const data = await axios.delete(`http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5002/heroBannerRouter/land/${id}`)
      console.log(data)
      fetchHeroBanner()
    }catch(err){
      console.log(err)  
  ...
  const deleteCustomerBanner = async (id) => {
    try{
      const data = await axios.delete(`http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5002/userBannerRouter/land/${id}`)
      console.log(data)
      fetchCustomerBanner()
    }catch(err){
      console.log(err)  

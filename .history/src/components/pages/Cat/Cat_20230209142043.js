...
const Cat = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const AddCustomerBanner = async (e) => {
      e.preventDefault()
      try{
        const data = await axios.post('http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5002/userBannerRouter/addlandtoBanner' , {image : url , desc })
        console.log(data)
        fetchCustomerBanner()
        props.onHide()
      }catch(err){
    ...
    const AddHeroBanner = async (e) => {
      e.preventDefault()
      try{
        const data = await axios.post('http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5002/heroBannerRouter/addHeroBanner' , {image : url , desc })
        console.log(data)
        fetchCustomerBanner()
        props.onHide()
      }catch(err){
      ...
      >
        ...
        <Modal.Body>
          <Form
            ...
            onSubmit={ban ? "" : AddCustomerBanner}
          >
            ...
            <Form.Group className="mb-3" controlId="formBasicEmail">
              ...
              <Form.Control type="text" onChange={(e) => setDesc(e.target.value)}  onClick={() => postDetails()} required />
            </Form.Group>

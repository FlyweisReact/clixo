...
const Cat = () => {
  ...
  const fetchCustomerBanner = async () => {
    try {
      const { data } = await axios.get(
        "https://5mkj1ib4ve.execute-api.ap-south-1.amazonaws.com/dev/userBannerRouter/land1"
      );
  ...
  const fetchHeroBanner = async () => {
    try {
      const { data } = await axios.get(
        "https://5mkj1ib4ve.execute-api.ap-south-1.amazonaws.com/dev/heroBannerRouter/land1"
      );
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const AddCustomerBanner = async (e) => {
      ...
      try {
        const data = await axios.post(
          "https://5mkj1ib4ve.execute-api.ap-south-1.amazonaws.com/dev/userBannerRouter/addlandtoBanner",
          { image: url, desc, link }
        );
        console.log(data);
        fetchCustomerBanner();
    ...
    const AddHeroBanner = async (e) => {
      ...
      try {
        const data = await axios.post(
          "https://5mkj1ib4ve.execute-api.ap-south-1.amazonaws.com/dev/heroBannerRouter/addHeroBanner",
          { image: url, desc, link }
        );
        console.log(data);
        fetchHeroBanner();
  ...
  const deleteheroBanner = async (id) => {
    try {
      const data = await axios.delete(
        `https://5mkj1ib4ve.execute-api.ap-south-1.amazonaws.com/dev/heroBannerRouter/land/${id}`
      );
      console.log(data);
      fetchHeroBanner();
    } catch (err) {
  ...
  const deleteCustomerBanner = async (id) => {
    try {
      const data = await axios.delete(
        `https://5mkj1ib4ve.execute-api.ap-south-1.amazonaws.com/dev/userBannerRouter/land/${id}`
      );
      console.log(data);
      fetchCustomerBanner();
    } catch (err) {
